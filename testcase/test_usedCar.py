...
class TestCase():
    ...
    def test_usedCar_collection(self,item,do_login):
        headers = {}
        ...
        if item['contentType']=='json':
            ...
            res = HttpResuest.http_request(url=item['url'], data=d, method=item['method'], headers=headers,s=do_login)
        ...
        try:
            assert str(r["code"])==str(item['excepted'])
            test_result='pass'
